  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="j2App.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="j2App.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('j2App.tag.name')}
                id="tag-name"
                name="name"
                data-cy="name"
                type="text"
