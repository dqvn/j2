    ...
    <Row>
      <Col md="8">
        <h2 data-cy="blogDetailsHeading">
          <Translate contentKey="j2App.blog.detail.title">Blog</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="j2App.blog.name">Name</Translate>
            </span>
          </dt>
          <dd>{blogEntity.name}</dd>
          <dt>
            <span id="handle">
              <Translate contentKey="j2App.blog.handle">Handle</Translate>
            </span>
          </dt>
          <dd>{blogEntity.handle}</dd>
          <dt>
            <Translate contentKey="j2App.blog.user">User</Translate>
          </dt>
