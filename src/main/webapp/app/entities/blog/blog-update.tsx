  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="j2App.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading">
            <Translate contentKey="j2App.blog.home.createOrEditLabel">Create or edit a Blog</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('j2App.blog.name')}
                id="blog-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('j2App.blog.handle')}
                id="blog-handle"
                name="handle"
                data-cy="handle"
                type="text"
              ...
              />
              <ValidatedField id="blog-user" name="user" data-cy="user" label={translate('j2App.blog.user')} type="select">
                <option value="" key="0" />
                {users
