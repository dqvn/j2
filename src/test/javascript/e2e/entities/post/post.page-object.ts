...
export class PostDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('j2App.post.delete.question'));
...
export default class PostComponentsPage {
  ...
  async deletePost() {
    ...
    expect(await postDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/j2App.post.delete.question/);
