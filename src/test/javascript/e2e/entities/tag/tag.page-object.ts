...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('j2App.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/j2App.tag.delete.question/);
